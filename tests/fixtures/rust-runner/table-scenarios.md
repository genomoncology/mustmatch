...
This table is intentionally in scope before the selected table. The later example names the selected table so the runner does not accidentally use this one.
...
```bash each_row="Selected Rows" table="Selected Rows"
