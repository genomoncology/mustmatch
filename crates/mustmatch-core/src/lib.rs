...
pub use comparator::{
    CompareMode, CompareResult, ContainsLineReport, analyze_contains_lines, compare,
    compare_ellipsis, contains, detect_mode, exact, extract_regex_pattern, has_ellipsis,
