...
6. Achieve 100% coverage using outmatchall itself
...
Replace all unit tests with documentation that uses outmatchall itself.
...
```bash
echo "hello" | outmatchall "world" || echo "failed as expected"
```
```
